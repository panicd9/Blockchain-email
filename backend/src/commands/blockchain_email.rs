...
pub mod blockchain_email {
    const _: () = {
        ::core::include_bytes!(
            "/home/darko/dapp-projects/blockchain-email/backend/src/commands/BlockchainEmail.json",
        );
    };
    #[allow(deprecated)]
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("addEncryptedSecretKeys",),
                        inputs: ::std::vec![
                            ...
                            ::ethers::core::abi::ethabi::Param {
                                name: ::std::borrow::ToOwned::to_owned("senderEncryptedSecretKey",),
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("getEncryptedSecretKey",),
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("s_addressToPublicKey",),
                        inputs: ::std::vec![::ethers::core::abi::ethabi::Param {
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("s_participantsToEncryptedSk",),
                        inputs: ::std::vec![::ethers::core::abi::ethabi::Param {
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("s_senderToRecipientMessages",),
                        inputs: ::std::vec![
                            ::ethers::core::abi::ethabi::Param {
            ...
            errors: ::core::convert::From::from([
                (
                    ::std::borrow::ToOwned::to_owned("Messanger__SecretKeyAlreadyInitialized"),
                ...
                (
                    ::std::borrow::ToOwned::to_owned("Messanger__SecretKeyNotInitialized"),
                    ::std::vec![::ethers::core::abi::ethabi::AbiError {
                        name: ::std::borrow::ToOwned::to_owned(
    ...
    pub static BLOCKCHAINEMAIL_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> BlockchainEmail<M> {
        ...
        pub fn message_sent_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, MessageSentFilter>
        {
            self.0.event()
        }
        ...
        pub fn public_key_added_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, PublicKeyAddedFilter>
        {
            self.0.event()
        }
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, BlockchainEmailEvents>
        {
            self.0
    ...
    impl ::ethers::core::abi::AbiDecode for BlockchainEmailErrors {
        fn decode(
            ...
            if let Ok(decoded) =
                <Messanger__SecretKeyAlreadyInitialized as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                )
            {
            ...
            if let Ok(decoded) =
                <Messanger__SecretKeyNotInitialized as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::core::convert::From<Messanger__SecretKeyAlreadyInitialized> for BlockchainEmailErrors {
        fn from(value: Messanger__SecretKeyAlreadyInitialized) -> Self {
            Self::Messanger__SecretKeyAlreadyInitialized(value)
        }
    }
    impl ::core::convert::From<Messanger__SecretKeyNotInitialized> for BlockchainEmailErrors {
    ...
    #[ethevent(
        name = "MessageSent",
        abi = "MessageSent(address,address,bytes,uint256)"
    )]
    ...
    #[ethevent(
        name = "PublicKeyAdded",
        abi = "PublicKeyAdded(address,bytes32,bytes32)"
    )]
    ...
    impl ::core::fmt::Display for BlockchainEmailEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::PublicKeyAddedFilter(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for BlockchainEmailCalls {
        fn decode(
            ...
            let data = data.as_ref();
            if let Ok(decoded) =
                <AddEncryptedSecretKeysCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::AddEncryptedSecretKeys(decoded));
            }
            if let Ok(decoded) = <AddPublicKeyCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::AddPublicKey(decoded));
            }
            if let Ok(decoded) =
                <GetEncryptedSecretKeyCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetEncryptedSecretKey(decoded));
            }
            if let Ok(decoded) = <GetMessagesCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::GetMessages(decoded));
            }
            if let Ok(decoded) = <GetPublicKeyCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetPublicKey(decoded));
            }
            if let Ok(decoded) =
                <SAddressToPublicKeyCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::SAddressToPublicKey(decoded));
            }
            if let Ok(decoded) =
                <SParticipantsToEncryptedSkCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::SParticipantsToEncryptedSk(decoded));
            }
            if let Ok(decoded) =
                <SSenderToRecipientMessagesCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for BlockchainEmailCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::AddPublicKey(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetEncryptedSecretKey(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::GetMessages(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetPublicKey(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for BlockchainEmailCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::AddEncryptedSecretKeys(element) => ::core::fmt::Display::fmt(element, f),
                Self::AddPublicKey(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetEncryptedSecretKey(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetMessages(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetPublicKey(element) => ::core::fmt::Display::fmt(element, f),
                Self::SAddressToPublicKey(element) => ::core::fmt::Display::fmt(element, f),
                Self::SParticipantsToEncryptedSk(element) => ::core::fmt::Display::fmt(element, f),
                Self::SSenderToRecipientMessages(element) => ::core::fmt::Display::fmt(element, f),
