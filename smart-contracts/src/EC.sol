...
contract EC {
    ...
    function _jAdd(uint256 x1, uint256 z1, uint256 x2, uint256 z2) public view returns (uint256 x3, uint256 z3) {
        (x3, z3) = (addmod(mulmod(z2, x1, n), mulmod(x2, z1, n), n), mulmod(z1, z2, n));
    }

    function _jSub(uint256 x1, uint256 z1, uint256 x2, uint256 z2) public view returns (uint256 x3, uint256 z3) {
        (x3, z3) = (addmod(mulmod(z2, x1, n), mulmod(n - x2, z1, n), n), mulmod(z1, z2, n));
    }

    function _jMul(uint256 x1, uint256 z1, uint256 x2, uint256 z2) public view returns (uint256 x3, uint256 z3) {
        (x3, z3) = (mulmod(x1, x2, n), mulmod(z1, z2, n));
    }

    function _jDiv(uint256 x1, uint256 z1, uint256 x2, uint256 z2) public view returns (uint256 x3, uint256 z3) {
    ...
    function _ecDouble(uint256 x1, uint256 y1, uint256 z1) public view returns (uint256 x3, uint256 y3, uint256 z3) {
    ...
    function publicKey(uint256 privKey) public view returns (uint256 qx, uint256 qy) {
        uint256 x;
        uint256 y;
        uint256 z;
    ...
    function deriveKey(uint256 privKey, uint256 pubX, uint256 pubY) public view returns (uint256 qx, uint256 qy) {
        uint256 x;
        uint256 y;
        uint256 z;
